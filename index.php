...
<html lang="en">
   <head>
      ...
      <!--  apple-touch-icon -->
      <link rel="apple-touch-icon-precomposed" sizes="144x144" href="assets/<?php echo get_template_directory_uri()?>/assets/img/ico/apple-touch-icon-144-precomposed.png">
      <link rel="apple-touch-icon-precomposed" sizes="114x114" href="assets/<?php echo get_template_directory_uri()?>/assets/img/ico/apple-touch-icon-114-precomposed.png">
      <link rel="apple-touch-icon-precomposed" sizes="72x72" href="assets/<?php echo get_template_directory_uri()?>/assets/img/ico/apple-touch-icon-72-precomposed.png">
      <link rel="apple-touch-icon-precomposed" href="assets/<?php echo get_template_directory_uri()?>/assets/img/ico/apple-touch-icon-57-precomposed.png">
      <?php wp_head(); ?>
         ...
         <nav class="navbar navbar-default navbar-sticky bootsnav">
            ...
            <div class="container">
                  ...
                  <ul>
                     ...
                     <li class="dropdown">
                        ...
                        <ul class="dropdown-menu cart-list">
                           <li>
                              <a href="#" class="photo"><img src="assets/<?php echo get_template_directory_uri()?>/assets/img/cart-1.jpg" class="cart-thumb" alt="" /></a>
                              <h2><a href="#">Denim SlimFit Shirt </a></h2>
                              <p>2x - <span class="price">$19.99</span></p>
                           </li>
                           <li>
                              <a href="#" class="photo"><img src="assets/<?php echo get_template_directory_uri()?>/assets/img/cart-3.jpg" class="cart-thumb" alt="" /></a>
               ...
               <div class="navbar-header">
                  ...
                  <a class="navbar-brand" href="index.html"><img src="assets/<?php echo get_template_directory_uri()?>/assets/img/logo.png" class="logo logo-scrolled" alt=""></a>
               </div>
      ...
      <footer>
         ...
         <div class="copyright-wrapper text-center">
            <div class="container">
               <div class="row">
                  <div class="col-md-12">
                     <p>Copyright@2021 Neuron Finance Inc. All Rights Reserved</a></p>
                  </div>
               </div>
               <!-- /.row -->
            </div>
